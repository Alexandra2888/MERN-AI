...
export default function HomeFeatures() {
  return (
    <>
      <section className="relative py-12 md:py-24 lg:py-32  bg-body overflow-hidden bg-slate-50 dark:bg-gray-900 ">
        <img
                  ...
                  <div className="slider-container">
                    <div className="slide flex mb-16 items-start">
                      ...
                      <div className="max-w-lg">
                        <h4 className="text-3xl font-medium text-gray-900 dark:text-white mb-8">
                          AI-Powered Content Creation
                        </h4>
                        <p className="text-xl text-gray-400">
                           AI revolutionizes the way you create content.
                    ...
                    <div className="slide flex mb-16 items-start">
                      ...
                      <div className="max-w-lg">
                        ...
                        <p className="text-xl text-gray-400">
                          ...
                          stories, AI tailors content to your specific
